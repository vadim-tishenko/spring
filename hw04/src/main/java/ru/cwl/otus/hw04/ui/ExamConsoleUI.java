...
public class ExamConsoleUI {
    ...
    public ExamConsoleUI(ExamFabricService examFabricService, MessageSource ms, LanguageService languageService) {
    ...
    private String tr(String key, Object... o) {
        return ms.getMessage(key, o, "key " + key + " don`t translated!", languageService.getLocale());
    }
}
